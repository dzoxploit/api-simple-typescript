 ...
 */
export declare function asSortedKeyValuesAsync<TSource, TKey>(source: Iterable<TSource>, keySelector: (x: TSource) => Promise<TKey>, ascending: boolean, comparer?: IComparer<TKey>): AsyncGenerator<TSource[], void, unknown>;
