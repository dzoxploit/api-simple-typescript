 ...
 */
export declare function asSortedKeyValues<TSource, TKey>(source: Iterable<TSource>, keySelector: (x: TSource) => TKey, ascending: boolean, comparer?: IComparer<TKey>): Generator<TSource[], void, unknown>;
